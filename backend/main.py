...
def chat(req: ChatRequest):
    ...
    return {
        ...
        "route_checks": progress.get("route_checks", []),
        "route_error": progress.get("route_error", ""),
        "city_markers": progress.get("city_markers", []),
        "city_marker_error": progress.get("city_marker_error", ""),
